...
public class HttpUtils {
    ...
    public static String sendPost(String url, String param) {
        ...
        try {
            ...
            conn.setRequestProperty("Accept-Charset", CharsetKitUtil.UTF8);
            conn.setRequestProperty("contentType", CharsetKitUtil.UTF8);
            ...
            try(BufferedReader in =new BufferedReader(new InputStreamReader(conn.getInputStream(), CharsetKitUtil.UTF8))) {
                String line;
                while ((line = in.readLine()) != null) {
                    result.append(line);
                }
